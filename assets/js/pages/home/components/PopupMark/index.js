    ...
    render() {
        return (
            <MarkCard>
                ...
                <Text text={this.state.description} showMore={this.showMore} seeMore={this.state.seeMore}/>
                <Link text={this.state.link}link={this.state.link} icon={this.state.linkIcon}/>
            </MarkCard>
        )
    }
}
